...
sed -i 's|<item id="title_page_xhtml" href="title_page.xhtml" media-type="application/xhtml+xml" />|<item id="title_page_xhtml" href="title_page.xhtml" media-type="application/xhtml+xml" />\n    <item id="preface_xhtml" href="preface.xhtml" media-type="application/xhtml+xml" />|g' $1/content.opf
sed -i 's|<itemref idref="title_page_xhtml" linear="no" />|<itemref idref="title_page_xhtml" linear="yes" />\n    <itemref idref="preface_xhtml" linear="yes" />|g' $1/content.opf
...
sed -i 's|<style type="text/css">code{white-space: pre;}</style>|<link rel="stylesheet" type="text/css" href="stylesheet.css" />|g' $1/preface.xhtml
